...
class bilevel_poisoning(object):
    ...
    def __init__(self, sess, x_train_tf, x_val_tf, x_test_tf, x_poison_tf, x_original_tf, y_train_tf, y_val_tf, y_val_class_tf, y_test_tf, y_poison_tf,
        ...
        #Classification loss unsmoothed
        ...
        self.ce_loss = tf.reduce_mean(tf.reduce_sum(-self.y_val_tf * self.log_softmax, 1))
        ...
        self.noisy_poisons = self.augmentation(self.u, Npoison) + self.noise_gp
        ...
        self.noisy_train = self.augmentation(self.x_train_tf, self.x_train_tf.shape[0]) + self.noise_gt
    ...
    def train(self, x_train, y_train, x_val, y_val, x_poisoned, y_poisoned, x_original, lr_u, lr_v, lr_p, niter1, niter2):
        ...
        fval, gval, f3, f4 = self.sess.run([self.f, self.g, self.ce_loss_unsmoothed, self.robustness_loss], feed_dict)
        
        return [f3, f4, fval, gval, hval, new_x_poisoned]
