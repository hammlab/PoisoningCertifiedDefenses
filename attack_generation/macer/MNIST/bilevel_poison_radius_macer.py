...
class bilevel_poisoning(object):
    ...
    def __init__(self, sess, x_train_tf, x_val_tf, x_test_tf, x_poison_tf, x_original_tf, y_train_tf, y_val_tf, y_train_class_tf, y_val_class_tf, y_test_tf, y_poison_tf,sigma_tf,
        ...
        #self.noise = tf.random.normal(self.repeated_x_val_tf.shape) * self.sigma_rs
        ...
        self.x_train_tf_reshaped = tf.reshape(self.x_train_tf, [-1, height*width*nch])
        ...
        self.u_reshaped = tf.reshape(self.u, [-1, height*width*nch])
